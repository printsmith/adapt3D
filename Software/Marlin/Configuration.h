...
#define STRING_CONFIG_H_AUTHOR "M3DP" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "adapt3D"
...
#define END_EFFECTOR_RADIUS 45.0 // 20.0mm for kossel end effector (used in the icepick delta)
...
#define END_EFFECTOR_TO_MOUNTPLATE 177.0

// vertical distance from the pulley axles to the mounting plate
#define PULLEY_MOUNT_HEIGHT 55.0
...
#define EXTRUDE_MINTEMP 170 //changed from 150
...
//    You must specify the X & Y coordinates of all 3 points
 ...
 // NONLINEAR_BED_LEVELING means: don't try to calculate linear coefficients but instead
  ...
  #define X_PROBE_OFFSET_FROM_EXTRUDER -36.37
...
#define XPulleyCircumference 282.4291795577224
#define YPulleyCircumference 282.4291795577224
#define ZPulleyCircumference 282.4291795577224
...
#define XStepsPulley ToothSpacing*StepsPerRotation*TopPulleyTeeth/(XPulleyEff*0.9)
#define YStepsPulley ToothSpacing*StepsPerRotation*TopPulleyTeeth/(YPulleyEff*0.9)
#define ZStepsPulley ToothSpacing*StepsPerRotation*TopPulleyTeeth/(ZPulleyEff*0.9)


#define DEFAULT_AXIS_STEPS_PER_UNIT   {XStepsPulley, YStepsPulley, ZStepsPulley, 98}

// delta speeds must be the same on xyz
// divide these values by approximately 2.5 as marlin calculates the speed at the motors, not the end effector
#define DEFAULT_MAX_FEEDRATE          {60, 60, 60, 40}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {200,200,200,3000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
