...
float removal_z = 0;
//int lovering_approximation_probe[4] = LOVERING_APPROXIMATION_PROBE;
//int lovering_docked_probe[4] = LOVERING_DOCKED_PROBE;
//int lovering_push_probe[4] = LOVERING_PUSH_PROBE;
//int lovering_returns_probe[4] = LOVERING_RETURNS_PROBE;
//int lifting_approximation_probe[4] = LIFTING_APPROXIMATION_PROBE;
//int lifting_docked_probe[4] = LIFTING_DOCKED_PROBE;
//int lifting_pressing_probe[4] = LIFTING_PRESSING_PROBE;
//int lifting_ride_probe[4] = LIFTING_RIDE_PROBE;
//int lifting_returns_probe[4] = LIFTING_RETURNS_PROBE;
#include "vector_3.h"
